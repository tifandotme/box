...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Root AGENTS.md lists the Ledger smoke commands agents should run after changing the workflow.
- [ ] #2 Root AGENTS.md says canary is production-mutating and should not be automatic.
- [ ] #3 n8n/AGENTS.md keeps Ledger-specific invariants and gotchas without duplicating root instructions.
<!-- AC:END -->
